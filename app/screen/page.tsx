  ...
  return (
    ...
    <div className="h-screen w-screen bg-black flex items-center justify-center overflow-hidden">
      ...
      >
        ...
        {/* ================= 🔵 左半部：藍方斜切立體艙 ================= */}
        <div 
          className="absolute left-0 top-0 h-full w-[1018px] z-10 shadow-[0_0_50px_rgba(37,99,235,0.4)]" // 💡 53vw 換算成 1018px
        ...
        {/* ================= 🔴 右半部：紅方斜切立體艙 ================= */}
        <div 
          className="absolute right-0 top-0 h-full w-[1018px] bg-[#2e0509] z-10 shadow-[0_0_50px_rgba(220,38,38,0.4)]" // 💡 53vw 換算成 1018px
        ...
        >
          ...
          >
            ...
            {/* 💡 修正天空巨型數字：提高透明度與加入光暈，使其更明顯 */}
            <div className="absolute right-[5%] top-[8%] text-[450px] font-black italic text-red-400/40 leading-none pointer-events-none z-0 tracking-tighter drop-shadow-[0_0_30px_rgba(248,113,113,0.4)]">
              {p2Int}
            </div>

      ...
      <div className="w-[320px] h-full bg-gradient-to-b from-zinc-900 to-black flex flex-col items-center justify-center relative z-30 shadow-[0_0_50px_rgba(0,0,0,1)] border-x border-zinc-800">
         ...
         <AnimatePresence mode="wait">
           {!match.show_lottery ? (
             ...
             <motion.div key="lottery" initial={{ scale: 0.5, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ opacity: 0 }} className="flex flex-col items-center justify-center w-full px-4 h-full">
               ...
               {/* 直播畫面中，垂直排列名單 */}
               <div className="w-full flex flex-col gap-2 overflow-hidden items-center justify-center">
                 ...
                 {match.lottery_winners?.length > 3 && (
                   <div className="text-yellow-500 text-xs font-bold mt-1">And {match.lottery_winners.length - 3} more...</div>
                 )}
               </div>
             </motion.div>
           )}
